...
def main(filename):
    ...
    newbytes_section = Custom_Section(newbytes, sh_addr = 0x09000000, sh_type=SHT_PROGBITS, sh_flags= SHF_WRITE | SHF_ALLOC | SHF_TLS, sh_addralign=0x4)
    #newbytes_section2 = Custom_Section(newbytes2, sh_addr =0x09001000, sh_type=SHT_NOBITS, sh_flags= SHF_WRITE | SHF_ALLOC | SHF_TLS)
    ...
    #newbytes_segment2 = Custom_Segment(PT_LOAD)
    ...
    #newbytes_segment2 = Custom_Segment(PT_TLS, p_align=4)
    #                                          Note the alignment. without this, it segfaults...
